...
using ImageResizer.OwinBackport.CallHeaders;
using ImageResizer.OwinBackport.Infrastructure;
using ImageResizer.OwinBackport.IntegratedPipeline;
...
namespace ImageResizer.OwinBackport
{
    ...
    {
        private const string TraceName = "ImageResizer.OwinBackport.OwinCallContext";
